...
class MCPClient:
    ...
    def __init__(self, config: ModelConfig, model, jsonrpc_handler: JSONRPCHandler):
        """
        MCPクライアントの初期化
    ...
    async def start_client(self, shutdown_event=None):
        """クライアント開始"""
        try:
            self.logger.info("MenZ-ReazonSpeech MCPクライアントを開始します...")
                ...
                try:
                    ...
                    async with websockets.connect(
                        ...
                        connect_msg = {
                            ...
                            "params": {
                                "text": "MenZ-ReazonSpeech接続完了",
                                "speaker": getattr(self.config, 'websocket_speaker', 'reazonspeech'),
                                "type": "system",
                                "language": "ja"
                            }
                        }
